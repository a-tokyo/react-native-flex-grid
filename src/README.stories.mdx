...
The grid is 100% modifiable, checkout the [detailed docs](/story/utils-grid--page)

### Responsive utils
Checkout the [detailed docs](/story/utils-responsive--page) for a set of useful responsive utilities like css/scss like media queries.

### Development
Checkout the [detailed docs](/story/development--page) to understand how to run the repo locally and how to develop with it.
